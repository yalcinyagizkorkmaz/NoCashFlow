...
const AdminPanel = () => {
  ...
  const filteredComplaints = complaints.filter(
    (complaint) => catagory === "all" || complaint.catagory === catagory
  );
    ...
    <div>
      <div className="header">
        ...
        <div className="header-right">
          ...
          <button className="logout-button" onClick={onButtonSikayetCikisClick}>
            Çıkış Yap
          </button>
        </div>
      </div>
        ...
        <form>
          <div className="filter-item">
              ...
              <g id="Filter icon">
                ...
                <g id="filter">
                  <path
                    ...
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M12.0265 28.6466C18.0489 28.6466 22.9311 26.9458 22.9311 24.8478C22.9311 22.7498 18.0489 21.0491 12.0265 21.0491C6.004 21.0491 1.12183 22.7498 1.12183 24.8478C1.12183 26.9458 6.004 28.6466 12.0265 28.6466Z"
                    stroke="white"
                    strokeWidth="2"
                    strokeLinecap="round"
                  ...
                  <path
                    id="Path"
                    d="M1.12183 24.8479C1.12466 28.6597 4.59581 31.971 9.51001 32.8498V38.1436C9.51001 39.1926 10.6367 40.043 12.0265 40.043C13.4163 40.043 14.5429 39.1926 14.5429 38.1436V32.8498C19.4571 31.971 22.9283 28.6597 22.9311 24.8479"
                    stroke="white"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            >
              ...
              <option value="MobilDeniz">MobilDeniz</option>
              <option value="Bireysel Kredi Kartları">
              ...
              <option value="Hesap/Kart Bloke Kaldırma">
                Hesap/Kart Bloke Kaldırma
              </option>
              <option value="EFT/Havale Teyit">EFT/Havale Teyit</option>
              <option value="Dolandırıcılık-Bilgi Dışı Şüpheli Hesap / Kart İşlemleri">
                Dolandırıcılık-Bilgi Dışı Şüpheli Hesap / Kart İşlemleri
              </option>
              <option value="Bilgi/Belge Sahtecilik / Kayıp">
                Bilgi/Belge Sahtecilik / Kayıp
              </option>
              <option value="Konut Sigortası">Konut Sigortası</option>
              <option value="Bireysel Kredi Hayat Sigortası">
              ...
              <tr key={index}>
                ...
                <td>
                  <div className="status-buttons">
                    ...
                    <button
                      className={`status-button ${
                        complaint.request_status === "Çözülüyor"
                    ...
                    <button
                      className={`status-button ${
                        complaint.request_status === "Çözüldü"
                          ? "resolved-button active"
                          : ""
                      }`}
                      style={{
                        backgroundColor:
                          complaint.request_status === "Çözüldü" ? "green" : "",
                      }}
                      disabled
                    >
                      Çözüldü
                    ...
                    <button
                      className="inceleme-button"
                      onClick={() => handleIncelemeChange(complaint.id)}
                    >
                      İnceleme
                    </button>
                  </div>
